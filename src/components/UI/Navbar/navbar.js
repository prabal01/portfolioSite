    ...
    >
      <Container>
        <SmoothList delay="300">
          <Navbar.Brand href="#home" style={{ color: "#64ffda" }}>
              <strong>
            {"< Prabal />"}
              </strong>
          </Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav>
            ...
            <SmoothList delay="900">
              <Nav.Link href="#Work"><span className={style.menuOption}><span className={style.number}>03.</span> Work</span></Nav.Link>
            </SmoothList>
            ...
            <SmoothList delay="1300">
              <Nav.Link href="#Contact"><CButton>Resume</CButton></Nav.Link>
            </SmoothList>
          </Nav>
        </Navbar.Collapse>
      </Container>
